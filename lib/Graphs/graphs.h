...
class Graph {
  ...
  public:
    Graph(Adafruit_GFX *gfx, const char *parameter_a, const char *unit_a, const char *parameter_b, const char *unit_b, graph_type type_a = line, graph_type type_b = line);
